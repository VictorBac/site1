 ...
 *
 * @ORM\Table()
 * @ORM\Entity(repositoryClass="site1\BlogBundle\Entity\CommentaireRepository")
 * @ORM\HasLifecycleCallbacks()
 */
class Commentaire
{
    /**
     * @ORM\ManyToOne(targetEntity="site1\BlogBundle\Entity\Article", inversedBy="commentaires")
